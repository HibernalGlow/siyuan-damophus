...
export default class TopicDictionaryPlugin extends SubPluginBase {
  ...
  private labels() {
    return {
      ...
      subjectNames: {
        civil: this.t("lets-topic-dictionary.subjectCivil"),
        criminal: this.t("lets-topic-dictionary.subjectCriminal"),
        "civil-procedure": this.t("lets-topic-dictionary.subjectCivilProcedure"),
        "criminal-procedure": this.t("lets-topic-dictionary.subjectCriminalProcedure"),
        administrative: this.t("lets-topic-dictionary.subjectAdministrative"),
        "commercial-economic": this.t("lets-topic-dictionary.subjectCommercialEconomic"),
        "theory-law": this.t("lets-topic-dictionary.subjectTheoryLaw"),
        "international-law": this.t("lets-topic-dictionary.subjectInternationalLaw"),
      },
