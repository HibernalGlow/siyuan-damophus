export const en = {
  "lets-mobile-appearance.displayName": "Mobile Appearance & Navigation",
  "lets-mobile-appearance.description": "Enhance mobile appearance with theme shortcuts, title paths, and theme-aware outline styling.",
  "lets-mobile-appearance.topBarShortcutTitle": "Top Bar Theme Mode Shortcut",
...
export const zhCN: typeof en = {
  "lets-mobile-appearance.displayName": "移动端外观与导航增强",
  "lets-mobile-appearance.description": "提供移动端外观与导航增强，包括外观模式快捷切换、顶栏/页签路径和适配主题的大纲样式。",
  "lets-mobile-appearance.topBarShortcutTitle": "顶栏外观模式快捷入口",
