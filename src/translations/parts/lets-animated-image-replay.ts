export const en = {
  ...
  "lets-animated-image-replay.description": "Let supported animated images finish naturally and replay them on demand",
...
export const zhCN: typeof en = {
  ...
  "lets-animated-image-replay.description": "让支持的动图自然播放完成，并可按需重新播放",
